...
**[measured]** **The agent CLI is a resident cost of its own, and nothing had measured it.** [580 MiB held for a session's whole life and 0.112 cores averaged over a day](measurements/2026-07-31-050322-the-agent-side-of-a-session.md), so a hundred sessions owe 58 GiB against a 22 GiB budget before an engine opens — **memory breaks at about 38 on the agent alone**. Cores stay behind it, though not by as much as that duty suggests: 0.112 belongs to a session waiting on a human, and [a driven one measures 0.27 by two independent routes](measurements/2026-07-31-054657-the-driven-duty.md), putting its core ceiling at 93 rather than two hundred. The same process has committed 1,096 MiB against those 580 resident, and the RSS condition reads the resident figure, so every ceiling here is the optimistic one — **and 93 carries a workload and a machine state with it**, since `η` rises with a session's footprint — [87 at 20 MiB against 97 at 33 on a rested box](measurements/2026-08-03-014841-the-gate-misses-by-three-percent.md) — and the same 20 MiB hold gives [51 once the box has slowed](measurements/2026-08-03-003443-the-footprint-result-was-the-machine.md). The engine's figure below is paid on top of that and only while it works.
