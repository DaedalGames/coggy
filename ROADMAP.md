...
**The larger term is the machine's own state.** The same hundred sessions at 20 MiB return **2.301** on a rested box and **3.958** on one that has recently been saturated — [72%](docs/measurements/2026-08-03-003443-the-footprint-result-was-the-machine.md), from a state that [a three-minute burst induces and that lasts about an hour](docs/measurements/2026-08-03-004512-a-saturating-burst-halves-the-box-for-an-hour.md). M1's verdict depends on that more than on anything the daemon or the workload does.
