...
| coggyd | Ours. **Added only after M1** | M1 — the daemon exists and [holds a hundred sessions for an hour](../docs/measurements/2026-08-01-103225-an-hour-of-a-hundred-sessions.md); what is missing is a ramp that drives it, which is this instrument's side rather than the daemon's |
