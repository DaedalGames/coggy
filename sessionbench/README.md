...
| coggyd | Ours. **Added only after M1** | M1 — the daemon [holds a hundred sessions for an hour](../docs/measurements/2026-08-01-103225-an-hour-of-a-hundred-sessions.md) and can now give each its own directory, so a ladder is buildable. **It will measure two of the four conditions**, for the reason below |
