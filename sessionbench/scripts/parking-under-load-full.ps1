...
#
# THE DUTY-1.0 ARM. Its sibling runs at 0.27, where a session is runnable only
# about a quarter of the time, so the box has brief gaps it could park into. Here
# there is no gap at all: the sessions never sleep. If the parked count still sits
# high, no idle fraction can account for it.
#
